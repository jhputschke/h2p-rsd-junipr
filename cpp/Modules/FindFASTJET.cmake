...
find_program(FASTJET_CONFIG NAMES fastjet-config PATHS ${FASTJET}/bin /opt/homebrew/bin)
...
message(STATUS "FastJet ${FASTJET_VERSION_MAJOR}.${FASTJET_VERSION_MINOR}.${FASTJET_VERSION_PATCH} installation found: ${FASTJET_LIBS_DIR}")
